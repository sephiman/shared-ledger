...
export function MovementImportCard() {
  ...
  const previewMut = usePreviewMovements(household.householdId);
  const executeMut = useExecuteMovements(household.householdId);
  ...
  return (
    <Card>
      ...
      <CardBody className="space-y-3">
        ...
        {preview && !result && <PreviewPanel preview={preview} dataset="movements" />}
