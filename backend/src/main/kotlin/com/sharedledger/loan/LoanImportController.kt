...
@RestController
@RequestMapping("/api/households/{householdId}/loans/import")
class LoanImportController(
    private val service: LoanImportService,
...
@RestController
@RequestMapping("/api/households/{householdId}/loans/payments/import")
class LoanPaymentImportController(
    private val service: LoanPaymentImportService,
    private val currentUser: CurrentUser,
    private val rateLimiter: ImportRateLimiter,
) {
