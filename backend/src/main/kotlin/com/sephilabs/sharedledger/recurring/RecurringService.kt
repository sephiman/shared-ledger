...
class RecurringService(
    ...
    fun list(householdId: UUID): List<RecurringTemplateDto> {
        val lastFired = transactions.lastFiredDatesByTemplate(householdId).associate { it.templateId to it.lastFired }
    ...
    /** Date of the last transaction actually generated by this template, or null if it has never fired. */
    @Transactional(readOnly = true)
    fun lastFired(templateId: UUID): LocalDate? = transactions.lastFiredDateForTemplate(templateId)
