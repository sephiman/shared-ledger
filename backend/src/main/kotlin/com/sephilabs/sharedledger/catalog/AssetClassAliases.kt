...
/** Legacy asset-class codes accepted on CSV import and mapped to current names, so files exported before
 *  a rename keep importing. 'index_funds' became 'fund' in V013. */
